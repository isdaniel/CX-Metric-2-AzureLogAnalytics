...
namespace CX_Metric_2_AzureLogAnalytics
{
    class LAWorkspace
    {
        ...
        public ILogger<LAWorkspace> Logger { get; }
        ...
        public LAWorkspace(ILogger<LAWorkspace> logger)
        {
            Logger = logger;
        }
        ...
        public void PostData(string signature, string date, string json, string logName)
        {
            try
            {
                ...
                {
                    Logger.LogInformation("metrics upload successfully!!");
                }
                
            }
            catch (Exception excep)
            {
                Logger.LogError(excep, "API Post Exception:" );
            }
        }
    }
}
